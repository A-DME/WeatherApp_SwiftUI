...
// Example URL   https://api.weatherapi.com/v1/forecast.json?key=609f907bf32f4932825110545240502&q=30.0715495,31.02
    ...
    class func getURLFor(_ something: URLFor, longitudeAndLatitude: (Double,Double) = (30.0715495, 31.02), imageFileURL: String = "//cdn.weatherapi.com/weather/64x64/day/116.png") -> String{
        ...
        case .forecast:
            ...
            result += URLComplitions.longLatt.rawValue + "\(String(longitudeAndLatitude.0)),\(String(longitudeAndLatitude.1))"
        case .conditionImage:
